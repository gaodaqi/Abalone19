...
load D:\highimbalance\abalone19\data\train3.txt;
...
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\basicdata_train3.txt','w');
...
err_train3
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\err_train3.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the test3 set.
load D:\highimbalance\abalone19\data\test3.txt;
load D:\highimbalance\abalone19\data\nte.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w0.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w1.txt;
...
err_test3
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\err_test3.txt','w');
    fprintf(fid,'%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n',err_test3');
fclose(fid);
...
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\Number_error_train3.txt','w');
    fprintf(fid,'\nFor the train3 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\Number_error_test3.txt','w');
    fprintf(fid,'\nFor the test3 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
