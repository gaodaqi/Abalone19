...
%%///////////////////////////////////////////////////////////////////////////////
    ...
    elseif numerror1>0&numerror2==0
       numerror(n,1)=(p0+q0)*(1/(1+alpha))*((pe+beta*0.01-2*beta*pe*0.01)/(2-pe-beta*0.01)+alpha*pe);
    elseif numerror1==0&numerror2>0
       numerror(n,1)=(p0+q0)*(1/(1+alpha))*((0.01+beta*qe-2*beta*0.01*qe)/(2-0.01-beta*qe)+alpha*pe);
    else
       numerror(n,1)=0;
    end
%%///////////////////////////////////////////////////////////////////////////////
