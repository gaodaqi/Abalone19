...
load D:\highimbalance\abalone19\data\train4.txt;
...
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\basicdata_train4.txt','w');
...
err_train4
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\err_train4.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the test4 set.
load D:\highimbalance\abalone19\data\test4.txt;
load D:\highimbalance\abalone19\data\nte.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w0.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w1.txt;
...
err_test4
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\err_test4.txt','w');
    fprintf(fid,'%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n',err_test4');
fclose(fid);
...
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\Number_error_train4.txt','w');
    fprintf(fid,'\nFor the train4 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\Number_error_test4.txt','w');
    fprintf(fid,'\nFor the test4 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
