...
load D:\highimbalance\abalone19\data\train2.txt;
load D:\highimbalance\abalone19\data\ntr.txt;
dim=size(train2,2)-2;
%dim=8;
sign0=[];
k0=1;
c=size(ntr,1);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\basicdata_train2.txt','w');
...
%        if ir<=19
        ...
        elseif numtr0(1)>0&numtr0(2)==0
           aver_index(1)=(1/(1+alpha))*((pe+beta*0.01-2*beta*pe*0.01)/(2-pe-beta*0.01)+alpha*pe);
        elseif numtr0(1)==0&numtr0(2)>0
           aver_index(1)=(1/(1+alpha))*((0.01+beta*qe-2*beta*0.01*qe)/(2-0.01-beta*qe)+alpha*pe);
        else
           aver_index(1)=0;
        end
%        end
...
%        if ir<=19
        ...
        elseif numtr0(1)>0&numtr0(2)==0
           aver_index(2)=(1/(1+alpha))*((pe+beta*0.01-2*beta*pe*0.01)/(2-pe-beta*0.01)+alpha*pe);
        elseif numtr0(1)==0&numtr0(2)>0
           aver_index(2)=(1/(1+alpha))*((0.01+beta*qe-2*beta*0.01*qe)/(2-0.01-beta*qe)+alpha*pe);
        else
           aver_index(2)=0;
        end
%        end
...
%        if ir<=19
        ...
        elseif numtr0(1)>0&numtr0(2)==0
           aver_index(3)=(1/(1+alpha))*((pe+beta*0.01-2*beta*pe*0.01)/(2-pe-beta*0.01)+alpha*pe);
        elseif numtr0(1)==0&numtr0(2)>0
           aver_index(3)=(1/(1+alpha))*((0.01+beta*qe-2*beta*0.01*qe)/(2-0.01-beta*qe)+alpha*pe);
        else
           aver_index(2)=0;
        end
%        end
%%/////////////////////////////////////////////////////////////////////////////////////////////
         ...
         fprintf(fid,'runtime(%d,%d)=%g\n',r,t,t1);
%///////////////////////////////////////////////////////////////////////////////////
         if (aver_index(3)>0.01)&(((ir>99)&(numtr_0(3)<=numtr_0(2))&(numtr_0(2)<=numtr_0(1)))|(ir<=99))
...
%        if ir<=19
        ...
        elseif numtr0(1)>0&numtr0(2)==0
           aver_index(4)=(1/(1+alpha))*((pe+beta*0.01-2*beta*pe*0.01)/(2-pe-beta*0.01)+alpha*pe);
        elseif numtr0(1)==0&numtr0(2)>0
           aver_index(4)=(1/(1+alpha))*((0.01+beta*qe-2*beta*0.01*qe)/(2-0.01-beta*qe)+alpha*pe);
        else
           aver_index(4)=0;
        end
%        end
...
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\w0.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w2');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\theta0.txt','w');
    fprintf(fid,'%.8f\n',theta2');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\w.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w4');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\theta.txt','w');
    fprintf(fid,'%.8f\n',theta4');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\w1.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w6');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\theta1.txt','w');
    fprintf(fid,'%.8f\n',theta6');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\w2.txt','w');
    fprintf(fid,'%.8f %.8f %.8f %.8f %.8f %.8f %.8f %.8f\n',w8');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\theta2.txt','w');
    fprintf(fid,'%.8f\n',theta8');
fclose(fid);
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\sign0.txt','w');
    fprintf(fid,'%g\n',sign0');
fclose(fid);
...
load D:\highimbalance\abalone19\data\train2.txt;
load D:\highimbalance\abalone19\data\ntr.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w0.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w1.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w2.txt;
load D:\highimbalance\abalone19\inv_dc1\result\theta0.txt;
load D:\highimbalance\abalone19\inv_dc1\result\theta.txt;
load D:\highimbalance\abalone19\inv_dc1\result\theta1.txt;
load D:\highimbalance\abalone19\inv_dc1\result\theta2.txt;
load D:\highimbalance\abalone19\inv_dc1\result\sign0.txt;
...
err_train2
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\err_train2.txt','w');
...
% Total, average, geometric accuracy; AUC:
% For the test2 set.
load D:\highimbalance\abalone19\data\test2.txt;
load D:\highimbalance\abalone19\data\nte.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w0.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w.txt;
load D:\highimbalance\abalone19\inv_dc1\result\w1.txt;
...
err_test2
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\err_test2.txt','w');
    fprintf(fid,'%g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g %g\n',err_test2');
fclose(fid);
...
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\Number_error_train2.txt','w');
    fprintf(fid,'\nFor the train2 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
...
fid=fopen('D:\highimbalance\abalone19\inv_dc1\result\Number_error_test2.txt','w');
    fprintf(fid,'\nFor the test2 set\n');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr');
    fprintf(fid,'\n%g %g %g %g %g %g %g %g %g %g\n',nerr1');
    fprintf(fid,'\n%g\n',sum(nerr'));
